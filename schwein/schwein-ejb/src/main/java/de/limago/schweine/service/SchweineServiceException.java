...
public class SchweineServiceException extends Exception {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 1998059114001401677L;
	...
	public SchweineServiceException(String message, Throwable cause, boolean enableSuppression,
